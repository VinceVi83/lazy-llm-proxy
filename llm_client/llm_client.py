...
class OllamaServiceAsync:
    ...
    Operates as follows:
        ...
        3. llm_call() creates LLMRequest and calls generate() for simplified usage.
    ...
    Methods:
        ...
        llm_call(self, system_prompt, user_prompt, model=None, options=None, mode='instruct') : Convenience method creating config and generating response.

    Usage:
        service = OllamaServiceAsync("http://localhost:11434")
        result = await service.llm_call("You are helpful", "Hello")
    """
    ...
    async def llm_call(self, system_prompt, user_prompt, model=None, options=None, mode='instruct'):
        config = LLMRequest(
...
class OllamaService:
    ...
    Operates as follows:
        ...
        5. llm_call() creates LLMRequest and calls generate().
    ...
    Usage:
        ...
        result = service.llm_call("You are helpful", "Hello")
    """
    ...
    def llm_call(self, system_prompt, user_prompt, model=None, options=None, mode='instruct'):
        config = LLMRequest(
            system_prompt=system_prompt,
            user_prompt=user_prompt,
            model=model,
...
class LLMGatewayClient:
    ...
    Operates as follows:
        ...
        7. llm_call() orchestrates full workflow including WOL if necessary.
    ...
    Methods:
        ...
        llm_call(self, system_prompt, user_prompt, model=None, options=None, mode='instruct') : Executes full request workflow with WOL support.

    Usage:
        client = LLMGatewayClient("192.168.1.100", 8000, "aa:bb:cc:dd:ee:ff", 9)
        result = client.llm_call("You are helpful", "Hello")
    """
...
class LLMGatewayClientAsync:
    ...
    Operates as follows:
        ...
        3. llm_call() creates LLMRequest and calls generate().
    ...
    Usage:
        ...
        result = await client.llm_call("You are helpful", "Hello")
    """
